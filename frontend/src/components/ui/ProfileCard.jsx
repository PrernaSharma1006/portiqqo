                ...
                <>
                  {avatarUrl && (
                    <div className="flex justify-center mb-4">
                      <img
                        className="w-24 h-24 rounded-full object-cover border-2 border-pink-400/40 shadow-md"
                        src={avatarUrl}
                  ...
                  <div className="text-center mb-6">
                    <h3 className="text-2xl font-extrabold text-stone-900 dark:text-stone-100">{name}</h3>
                    <p className="text-sm font-medium text-pink-500 dark:text-pink-400 mt-1">{title}</p>
                  </div>
