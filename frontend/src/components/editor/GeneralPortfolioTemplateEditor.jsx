...
import GeneralPortfolioTemplate from '../templates/GeneralPortfolioTemplate'
import { 
  ArrowLeft, 
  Save, 
  Eye, 
  ...
  if (isPreview) {
    return (
      <div ref={previewRef} className="min-h-screen bg-gray-50">
        ...
        <GeneralPortfolioTemplate isPublic={true} portfolioData={portfolioData} />
      </div>
    )
  }
  ...
  return (
    <div className="min-h-screen bg-gray-50">
      ...
      <PDFPaymentModal 
        ...
        portfolioName={portfolioData.profile?.name ? `${portfolioData.profile.name}'s Portfolio` : 'General Portfolio'}
      />
    </div>
  )
}
