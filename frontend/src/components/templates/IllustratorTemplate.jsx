  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-purple-50 to-pink-50">
      ...
      <TemplateFooter
        ...
        title={illustratorData.title}
        tagline={illustratorData.bio || 'Digital Illustrator & Visual Storyteller'}
        email={illustratorData.email}
        phone={illustratorData.phone}
        location={illustratorData.location}
        socialLinks={{
          instagram: illustratorData.social?.instagram,
          behance: illustratorData.social?.behance,
          website: illustratorData.website
        }}
        quickLinks={[
