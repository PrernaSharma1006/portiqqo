...
function HomePage() {
  ...
  return (
    <>
      ...
      {/* Hero Section */}
      <section className="relative overflow-x-hidden max-w-full w-full bg-[#f9f6f0] dark:bg-[#141210] border-b border-[#e6ccb2]/60 dark:border-stone-800/80 pt-6 sm:pt-10 lg:pt-4 pb-10 sm:pb-16 lg:pb-14">
            ...
            <div className="grid lg:grid-cols-2 gap-6 lg:gap-8 items-center w-full">
              ...
              <div className="space-y-5 lg:space-y-5 w-full max-w-full overflow-x-hidden text-center lg:text-left flex flex-col items-center lg:items-start">
                ...
                <motion.div variants={fadeInUp} className="w-full max-w-full overflow-x-hidden">
                  <h1 className="text-3xl sm:text-5xl md:text-6xl lg:text-7xl font-heading font-black text-stone-900 dark:text-stone-50 leading-[1.08] tracking-tight flex flex-col items-center lg:items-start gap-1 sm:gap-2 max-w-full overflow-x-hidden">
                ...
                <motion.p 
                  className="text-base sm:text-lg text-stone-600 dark:text-stone-300 leading-relaxed max-w-lg mx-auto lg:mx-0 font-normal"
                  variants={fadeInUp}
                >
                ...
                <motion.div 
                  className="flex flex-col sm:flex-row gap-3 sm:gap-4 w-full sm:w-auto pt-1 justify-center lg:justify-start"
                  variants={fadeInUp}
                >
                  <Link 
                    to="/auth" 
                    className="w-full sm:w-auto px-6 sm:px-8 py-3 sm:py-3.5 bg-[#f472b6] hover:bg-[#ec4899] text-stone-950 rounded-2xl font-extrabold text-base shadow-lg shadow-pink-500/20 transition-all duration-300 hover:-translate-y-0.5 flex items-center justify-center group"
                  >
                    Start Building Free
